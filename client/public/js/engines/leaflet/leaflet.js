...
!(function(t, i) {
    ...
    return (
      'touchstart' === i
        ...
        : 'touchmove' === i
          ...
          : 'touchend' === i && (t.removeEventListener(ie, n, !1), t.removeEventListener(ee, n, !1)),
      this
    )
  }
  function O(t, i, n) {
  ...
  function q(t, i, e, n) {
    ...
    else if (i) for (var s = 0, r = (i = u(i)).length; s < r; s++) K(t, i[s], e, n)
    else {
  ...
  function wt(t, i, e) {
    var n = i || new x(0, 0)
    t.style[pe] =
      (Oi ? 'translate(' + n.x + 'px,' + n.y + 'px)' : 'translate3d(' + n.x + 'px,' + n.y + 'px,0)') +
      (e ? ' scale(' + e + ')' : '')
  }
  function Lt(t, i) {
    ...
    for (r = 0; r < 4; r++) {
      for (l = _[r], n = [], o = 0, s = (u = t.length) - 1; o < u; s = o++)
        (a = t[o]),
          (h = t[s]),
          a._code & l
            ? h._code & l || (((c = At(h, a, l, i, e))._code = Bt(c, i)), n.push(c))
            : (h._code & l && (((c = At(h, a, l, i, e))._code = Bt(c, i)), n.push(c)), n.push(a))
      t = n
    }
    return t
  }
        ...
        if (i) {
          if ((e === this && (e = void 0), n))
            for (o = 0, s = n.length; o < s; o++) {
              var a = n[o]
              if (a.ctx === e && a.fn === i)
                return (a.fn = r), this._firingCount && (this._events[t] = n = n.slice()), void n.splice(o, 1)
            }
        } else {
  ...
  ;(x.prototype = {
    ...
    (P.prototype = {
      ...
      contains: function(t) {
        var i, e
        return (
          (t = 'number' == typeof t[0] || t instanceof x ? w(t) : b(t)) instanceof P
            ? ((i = t.min), (e = t.max))
            : (i = e = t),
    ...
    (T.prototype = {
      ...
      contains: function(t) {
        ...
        var i,
          ...
          o = this._northEast
        return (
          t instanceof T ? ((i = t.getSouthWest()), (e = t.getNorthEast())) : (i = e = t),
      ...
      equals: function(t, i) {
        return (
          !!t &&
          ((t = z(t)), this._southWest.equals(t.getSouthWest(), i) && this._northEast.equals(t.getNorthEast(), i))
        )
      },
      isValid: function() {
    ...
    (M.prototype = {
      equals: function(t, i) {
        return (
          !!t &&
          ((t = C(t)), Math.max(Math.abs(this.lat - t.lat), Math.abs(this.lng - t.lng)) <= (void 0 === i ? 1e-9 : i))
        )
      },
      toString: function(t) {
  ...
  var pi,
    ...
    Vi =
      !window.L_NO_TOUCH &&
      (Ui || 'ontouchstart' in window || (window.DocumentTouch && document instanceof window.DocumentTouch)),
    qi = ji && Zi,
    Gi = ji && Ei,
  ...
  var ve,
    ...
    Le = ui.extend({
      ...
      setMinZoom: function(t) {
        ...
        return (
          ...
          this._loaded && i !== t && (this.fire('zoomlevelschange'), this.getZoom() < this.options.minZoom)
            ? this.setZoom(t)
            : this
        )
      },
      setMaxZoom: function(t) {
        ...
        return (
          ...
          this._loaded && i !== t && (this.fire('zoomlevelschange'), this.getZoom() > this.options.maxZoom)
            ? this.setZoom(t)
            : this
        )
      },
        ...
        return a.x || a.y
          ? (t.animate && t.pan
              ...
              : (t.pan && this._rawPanBy(a),
                this.fire('move'),
                t.debounceMoveend
                  ? (clearTimeout(this._sizeTimer), (this._sizeTimer = setTimeout(e(this.fire, this, 'moveend'), 200)))
                  : this.fire('moveend')),
      ...
      getSize: function() {
        return (
          (this._size && !this._sizeChanged) ||
            ((this._size = new x(this._container.clientWidth || 0, this._container.clientHeight || 0)),
            (this._sizeChanged = !1)),
          this._size.clone()
        )
      },
      ...
      _initPanes: function() {
        ...
        ;(this._paneRenderers = {}),
          ...
          this.options.markerZoomAnimation ||
            (pt(t.markerPane, 'leaflet-zoom-hide'), pt(t.shadowPane, 'leaflet-zoom-hide'))
      },
    ...
    Pe = v.extend({
      ...
      remove: function() {
        return this._map
          ? (ut(this._container), this.onRemove && this.onRemove(this._map), (this._map = null), this)
          : this
      },
  ...
  var Te = Pe.extend({
      ...
      expand: function() {
        ...
        return (
          t < this._form.clientHeight
            ? (pt(this._form, 'leaflet-control-layers-scrollbar'), (this._form.style.height = t + 'px'))
      ...
      _initLayout: function() {
        ...
        e &&
          ...
          Ti || V(i, { mouseenter: this.expand, mouseleave: this.collapse }, this))
        var o = (this._layersLink = ht('a', t + '-toggle', i))
        ;(o.href = '#'),
          (o.title = 'Layers'),
          Vi ? (V(o, 'click', Q), V(o, 'click', this.expand, this)) : V(o, 'focus', this.expand, this),
          e || this.expand(),
  ...
  var Se,
    ...
    Be = ui.extend({
        ...
        if (
          ...
          !dt(this._element, 'leaflet-zoom-anim') &&
            !(
              ...
              ((Be._dragging = this), this._preventOutline && zt(this._element), bt(), mi(), this._moving)
            ))
        ) {
          this.fire('down')
      ...
      finishDrag: function() {
        mt(document.body, 'leaflet-dragging'),
          this._lastTarget && (mt(this._lastTarget, 'leaflet-drag-target'), (this._lastTarget = null))
        for (var t in Ae) q(document, Ae[t], this._onMove, this), q(document, Ie[t], this._onUp, this)
        Tt(),
          fi(),
          this._moved &&
            this._moving &&
            (g(this._animRequest), this.fire('dragend', { distance: this._newPos.distanceTo(this._startPos) })),
          (this._moving = !1),
          (Be._dragging = !1)
      }
    }),
    ...
    He = i({}, _i, { code: 'EPSG:4326', projection: De, transformation: S(1 / 180, 1, -1 / 180, 0.5) }),
    Fe = i({}, ci, {
      projection: De,
    ...
    qe = Ve.extend({
      addLayer: function(t) {
        return this.hasLayer(t)
          ? this
          : (t.addEventParent(this), Ve.prototype.addLayer.call(this, t), this.fire('layeradd', { layer: t }))
      },
      removeLayer: function(t) {
        return this.hasLayer(t)
    ...
    Xe = Ue.extend({
      ...
      _initInteraction: function() {
        if (
          ...
          (pt(this._icon, 'leaflet-interactive'), this.addInteractiveTarget(this._icon), Ye)
        ) {
      ...
      _project: function() {
        ...
        if (n.distance === _i.distance) {
          var o = Math.PI / 180,
            ...
            u = e.unproject(h).lat,
            l =
              Math.acos((Math.cos(s * o) - Math.sin(i * o) * Math.sin(u * o)) / (Math.cos(i * o) * Math.cos(u * o))) / o
  ...
  var sn = Kt,
    rn = Ue.extend({
      ...
      onAdd: function() {
        this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
          this.options.interactive && (pt(this._image, 'leaflet-interactive'), this.addInteractiveTarget(this._image)),
    ...
    hn = Ue.extend({
      ...
      onRemove: function(t) {
        t._fadeAnimated
          ? (vt(this._container, 0), (this._removeTimeout = setTimeout(e(ut, void 0, this._container), 200)))
          : ut(this._container)
      },
      getLatLng: function() {
        return this._latlng
    ...
    un = hn.extend({
      ...
      _updateLayout: function() {
        ...
        o && n > o ? ((i.height = o + 'px'), pt(t, 'leaflet-popup-scrolled')) : mt(t, 'leaflet-popup-scrolled'),
    ...
    Le.include({
      openPopup: function(t, i, e) {
        return (
          ...
          this.hasLayer(t)
            ? this
            : (this._popup && this._popup.options.autoClose && this.closePopup(), (this._popup = t), this.addLayer(t))
        )
      },
    ...
    Ue.include({
      bindPopup: function(t, i) {
        return (
          t instanceof un
            ...
            : ((this._popup && !i) || (this._popup = new un(i, this)), this._popup.setContent(t)),
      ...
      openPopup: function(t, i) {
        ...
        return (
          ...
          this._popup &&
            this._map &&
            ((this._popup._source = t), this._popup.update(), this._map.openPopup(this._popup, i)),
          this
        )
      },
      closePopup: function() {
      ...
      bindTooltip: function(t, i) {
        return (
          t instanceof ln
            ...
            : ((this._tooltip && !i) || (this._tooltip = new ln(i, this)), this._tooltip.setContent(t)),
        ...
        return (
          ...
          this._tooltip &&
            ...
            this._tooltip.options.interactive &&
              ...
              (pt(this._tooltip._container, 'leaflet-clickable'), this.addInteractiveTarget(this._tooltip._container))),
          this
        )
      },
  ...
  var _n = Ue.extend({
      ...
      _updateOpacity: function() {
        if (this._map && !Li) {
          ...
          e && !this._noPrune && this._pruneTiles(),
            i && (g(this._fadeFrame), (this._fadeFrame = f(this._updateOpacity, this)))
        }
      },
      _onOpaqueTile: r,
      _initContainer: function() {
        this._container ||
          ((this._container = ht('div', 'leaflet-layer ' + (this.options.className || ''))),
          this._updateZIndex(),
        ...
        if (void 0 !== t) {
          for (var e in this._levels)
            this._levels[e].el.children.length || e === t
              ...
              : (ut(this._levels[e].el), this._removeTilesAtZoom(e), this._onRemoveLevel(e), delete this._levels[e])
      ...
      _retainParent: function(t, i, e, n) {
        ...
        return u && u.active
          ? ((u.retain = !0), !0)
          : (u && u.loaded && (u.retain = !0), r > n && this._retainParent(o, s, r, n))
      },
      ...
      _tileReady: function(t, i, n) {
        if (this._map) {
          ...
          ;(n = this._tiles[o]) &&
            ...
            i || (pt(n.el, 'leaflet-tile-loaded'), this.fire('tileload', { tile: n.el, coords: t })),
            this._noTilesToLoad() &&
              ((this._loading = !1),
              this.fire('load'),
  ...
  var mn = Ue.extend({
      ...
      onAdd: function() {
        this._container || (this._initContainer(), this._zoomAnimated && pt(this._container, 'leaflet-zoom-animated')),
          this.getPane().appendChild(this._container),
          this._update(),
    ...
    fn = mn.extend({
      ...
      _fillStroke: function(t, i) {
        var e = i.options
        e.fill &&
          ((t.globalAlpha = e.fillOpacity), (t.fillStyle = e.fillColor || e.color), t.fill(e.fillRule || 'evenodd')),
          e.stroke &&
            0 !== e.weight &&
      ...
      _handleMouseOut: function(t) {
        ...
        i &&
          (mt(this._container, 'leaflet-interactive'), this._fireEvent([i], t, 'mouseout'), (this._hoveredLayer = null))
      },
        ...
        ;(o.stroked = !!n.stroke),
          ...
          n.stroke
            ? (i || (i = t._stroke = gn('stroke')),
              ...
              (i.opacity = n.opacity),
              n.dashArray
                ? (i.dashStyle = ei(n.dashArray) ? n.dashArray.join(' ') : n.dashArray.replace(/( *, *)/g, ' '))
                : (i.dashStyle = ''),
  ...
  Ji && xn.include(vn),
    Le.include({
      getRenderer: function(t) {
        ...
        return (
          i || (i = this._renderer = (this.options.preferCanvas && Xt()) || Jt()),
      ...
      _getPaneRenderer: function(t) {
        ...
        return (
          void 0 === i && ((i = (xn && Jt({ pane: t })) || (fn && Xt({ pane: t }))), (this._paneRenderers[t] = i)), i
        )
      }
    })
  var wn = en.extend({
  ...
  var Ln = Ze.extend({
    ...
    _onMouseDown: function(t) {
      ...
      this._clearDeferredResetState(),
        ...
        V(
          document,
          { contextmenu: Q, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown },
          this
        )
    },
    _onMouseMove: function(t) {
  ...
  var Tn = Ze.extend({
    ...
    addHooks: function() {
      ...
      t.tabIndex <= 0 && (t.tabIndex = '0'),
        V(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
        this._map.on({ focus: this._addHooks, blur: this._removeHooks }, this)
    },
    removeHooks: function() {
      this._removeHooks(),
        q(this._map._container, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
