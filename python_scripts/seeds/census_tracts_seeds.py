...
def create_table(c):
    ...
    c.execute('CREATE UNIQUE INDEX idx_ct_boro_code_and_name ON {tn}({col1}, {col2})'.format(
        tn=table, col1=col5, col2=col3))
    c.execute('CREATE UNIQUE INDEX idx_ct_boro_code_and_ctlabel ON {tn}({col1}, {col2})'.format(
