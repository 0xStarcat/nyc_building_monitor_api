...
def seed_census_tracts(c, census_tract_json):
  ...
  c.execute('CREATE TABLE IF NOT EXISTS {tn} (id INTEGER PRIMARY KEY AUTOINCREMENT, {col1} INTEGER NOT NULL REFERENCES {ref_table1}(id), {col2} INTEGER NOT NULL REFERENCES {ref_table2}(id), {col3} INTEGER NOT NULL REFERENCES {ref_table3}(id), {col4} TEXT, {col5} TEXT, {col6} INT, {col7} TEXT, {col8} INT, {col9} INT, {col10} INT, {col11} INT, {col12} INT, {col13} INT, {col14} INT, {col15} INT, {col16} INT, {col17} TEXT)'\
    .format(tn=census_tracts_table, ref_table1=boroughs_seeds.boroughs_table, ref_table2=community_districts_seeds.community_districts_table, ref_table3=neighborhoods_seeds.neighborhoods_table, col1=ct_col1, col2=ct_col2, col3=ct_col3, col4=ct_col4, col5=ct_col5, col6=ct_col6, col7=ct_col7, col8=ct_col8, col9=ct_col9, col10=ct_col10, col11=ct_col11, col12=ct_col12, col13=ct_col13, col14=ct_col14, col15=ct_col15, col16=ct_col16, col17=ct_col17))
