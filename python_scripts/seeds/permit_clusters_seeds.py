...
def create_table(c):
  ...
  c.execute('CREATE INDEX idx_permit_cluster_borough_id ON {tn}({col1})'.format(tn=permit_clusters_table, col1=permit_cluster_col1))
  ...
  c.execute('CREATE INDEX idx_permit_cluster_neighborhood_id ON {tn}({col3})'.format(tn=permit_clusters_table, col3=permit_cluster_col3))
  c.execute('CREATE INDEX idx_permit_cluster_census_tract_id ON {tn}({col4})'.format(tn=permit_clusters_table, col4=permit_cluster_col4))
