...
def create_table(c):
  ...
  c.execute('CREATE INDEX idx_permit_borough_id ON {tn}({col1})'.format(tn=permits_table, col1=permit_col1))
  c.execute('CREATE INDEX idx_permit_community_district_id ON {tn}({col2})'.format(tn=permits_table, col2=permit_col2))
  c.execute('CREATE INDEX idx_permit_neighborhood_id ON {tn}({col3})'.format(tn=permits_table, col3=permit_col3))
  c.execute('CREATE INDEX idx_permit_census_tract_id ON {tn}({col4})'.format(tn=permits_table, col4=permit_col4))
  c.execute('CREATE INDEX idx_permit_permit_cluster_id ON {tn}({col5})'.format(tn=permits_table, col5=permit_col5))
  c.execute('CREATE INDEX idx_permit_type ON {tn}({col9})'.format(tn=permits_table, col9=permit_col9))
  c.execute('CREATE INDEX idx_permit_owner_business_name ON {tn}({col10})'.format(tn=permits_table, col10=permit_col10))
