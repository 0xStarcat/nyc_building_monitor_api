...
source = "HPD"
dob_url = 'https://data.cityofnewyork.us/resource/fhrw-4uyv.json?agency=HPD&$where=created_date between "'+ api_helpers.get_next_day_to_request(c, table, source) + '" and "' + api_helpers.get_today(table, source) + '"&'
