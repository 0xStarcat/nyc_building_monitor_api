...
def api_request(table, source):
  if source == 'DOB':
    ...
    url = 'https://data.cityofnewyork.us/resource/gq3f-5jm8.json?$where=issue_date > "'+ api_helpers.get_previous_days(table, source, 365) + '" AND hearing_status is not PENDING&'
  elif source == "HPD":
