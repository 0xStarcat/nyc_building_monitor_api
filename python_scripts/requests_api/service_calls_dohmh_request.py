...
source = "dohmh"
dob_url = 'https://data.cityofnewyork.us/resource/fhrw-4uyv.json?agency=dohmh&$where=issue_date between "'+ api_helpers.get_next_day_to_request(table, source) + '" and "' + api_helpers.get_today(table, source) + '"&'
