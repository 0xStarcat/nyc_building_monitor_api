...
6. Download the raw data from this dropbox ([link](https://www.dropbox.com/sh/oneei3xguhpzg8b/AABRKiQZPacG0KYRSO5eX6eaa?dl=0)) and place the `data` directory into the project root.
